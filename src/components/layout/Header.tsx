...
export default function Header() {
  ...
  return (
    <div className="flex w-full items-center justify-between rounded-[5vw] border bg-black/15 p-3 text-xs tracking-tighter transition-colors sm:p-5 sm:text-sm">
